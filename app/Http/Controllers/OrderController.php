...
class OrderController extends Controller
{
    ...
    //                 ];
    //             }
    //             $statistics[$productId]['total_quantity'] += $item->quantity;
    //             $statistics[$productId]['total_revenue'] += $item->quantity * $item->price;
    //         }
    //     }

    //     return response()->json(array_values($statistics));
    // }
